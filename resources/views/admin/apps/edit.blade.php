        ...
        <form method="POST" action="{{ route('admin.apps.update', $app) }}">
            ...
            <div class="mb-6">
                ...
                <select id="midtrans_environment"
                    ...
                    <option value="sandbox" {{ old('midtrans_environment', $app->midtrans_environment ?? config('midtrans.default_environment', 'sandbox')) === 'sandbox' ? 'selected' : '' }}>Sandbox</option>
                    <option value="production" {{ old('midtrans_environment', $app->midtrans_environment ?? config('midtrans.default_environment', 'sandbox')) === 'production' ? 'selected' : '' }}>Production</option>
                </select>
